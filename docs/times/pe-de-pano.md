  ...
  <tbody>
    <tr>
      <td colspan="2" align="center" style="text-align: center; padding: 15px; border: 1px solid #d8dee4; background-color: #ffffff;">
        <img src="https://github.com/user-attachments/assets/658458ae-c363-43cb-8865-cafbe5b672ac" width="150" alt="Escudo de Pé de Pano" style="display: block; margin: 0 auto;" />
      </td>
    </tr>
    <tr>
...
Desde o inicio das atividades, passaram diversos atletas pelo time, mas a base sempre foi a mesma de sua formação. Em 2006 conseguimos nosso primeiro titulo oficial, através da conquista do Torneio da Amizade, organizado pela Família Rehme, torneio que foi conquistado também em outras 4 edições.
