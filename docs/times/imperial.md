...
<table align="right" width="280" style="margin-left: 20px; margin-bottom: 20px; border: 1px solid #d8dee4; border-collapse: collapse; font-family: sans-serif;">
  <thead>
    <tr style="background-color: #f6f8fa;">
      <th colspan="2" style="padding: 10px; border: 1px solid #d8dee4; text-align: center; font-size: 1.1em;">Imperial Futebol Clube</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td colspan="2" style="text-align: center; padding: 15px; border: 1px solid #d8dee4; background-color: #ffffff;">
        <img src="https://github.com/user-attachments/assets/41dd552d-d620-4f60-80da-ae04a67e7143" width="150" alt="Escudo de Imperial Futebol Clube" />
      </td>
    </tr>
    <tr>
      <td style="padding: 8px; border: 1px solid #d8dee4; font-weight: bold; background-color: #f6f8fa; width: 35%;">Nome completo</td>
      <td style="padding: 8px; border: 1px solid #d8dee4; background-color: #ffffff;">Imperial Futebol Clube</td>
    </tr>
    <tr>
...
O Imperial Futebol Clube, é um clube formado no ano de 2023, por antigos estudantes do Colégio Estadual do Paraná, sendo esses, Vitor Tibucheski, Vinicius Rodrigues e Vinicius Ceislak.

Originalmente o Imperial utilizava o nome de Kiefernwald Futebol Clube, que traduzindo do alemão para o português, significa "floresta de pinheiros", características árvores da cidade de Curitiba. Seu escudo detém detalhes que remetem ao brasão do estado do Paraná, constando principalmente com a presença da "Harpya Brasileira", conhecida como "Águia Imperial"(nome esse que viria inspirar a mudança "abrasileirada" do nome do clube para o atual "Imperial"), que também representa o mascote do clube.
